...
#define JSONXX_ASSERT(...)                                                                                                                                                                             \
    do {                                                                                                                                                                                               \
        __pragma(warning(push)) __pragma(warning(disable : 4127)) if (jsonxx::Assertions) __pragma(warning(pop)) jsonxx::assertion(__FILE__, __LINE__, #__VA_ARGS__, bool(__VA_ARGS__));               \
...
#undef $number
    ...
    template <size_t N> Value(const char (&t)[N]) : type_(INVALID_) { import(std::string(t)); }
...
namespace std {
inline std::string to_string(const jsonxx::Object &p) { return p.json(); }
inline std::string to_string(const jsonxx::Object *p) { return p->json(); }
inline std::string to_string(const jsonxx::Array &p) { return p.json(); }
inline std::string to_string(const jsonxx::Array *p) { return p->json(); }
inline std::string to_string(const jsonxx::Value &p) {
    using Value = jsonxx::Value;
    switch (p.type_) {
    case Value::OBJECT_:
        return to_string(p.object_value_);
    case Value::ARRAY_:
        return to_string(p.array_value_);
    case Value::STRING_:
        return *p.string_value_;
    case Value::NUMBER_:
        return to_string(p.number_value_);
    case Value::BOOL_:
        return p.bool_value_ ? "true" : "false";
    case Value::NULL_:
        return "null";
    }
    return "";

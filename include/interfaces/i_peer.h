...
protected:
	virtual SharedPtr<const IInput> get_local_input() = 0;
	virtual SharedPtr<const IInput> predict_remote_input(const SharedPtr<const IInput> &p_previous_input, const Tick_t p_ticks_since_real_input) = 0;
